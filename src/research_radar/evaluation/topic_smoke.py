    ...
    for spec in specs:
        try:
            run_dir = runner(
                ...
                spec.id,
                connectors,
                verifier=verifier or provider,
                verifier_model=verifier_model or model,
                gist_provider=gist_provider,
                gist_model=gist_model,
                limit=limit,
                deep_reader=reader or provider,
                deep_model=reader_model or model,
